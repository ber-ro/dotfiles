...
(custom-set-variables
 ...
 '(default-frame-alist '((width . 100) (top . 20) (left - 80)))
 ...
 '(electric-pair-pairs '((34 . 34) (39 . 39)))
 ...
 '(fast-lock-save-events '(save-buffer kill-buffer kill-emacs))
 ...
 '(ido-everywhere nil)
 '(ido-ignore-directories-merge '("^[abefghijklmnopqrstuvwxyzABEFGHIJKLMNOPQRSTUVWXYZ]:"))
 '(ido-ignore-files
   '("\\`CVS/" "\\`#" "\\`.#" "\\`\\.\\./" "\\`\\./" "_tmp" "\\.doc$"))
 ...
 '(recentf-exclude '("[/\\]te?mp[/\\]\\|\\.timelog$\\|\\.ido\\.last$"))
